...
if (con == 2 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    draw_text((view_xview[0] + 50), (view_yview[0] + 15), scr_gettext("labtv_cancel"))
    draw_text((view_xview[0] + 160), (view_yview[0] + 15), scr_gettext("labtv_tape1"))
    draw_text((view_xview[0] + 50), (view_yview[0] + 35), scr_gettext("labtv_tape2"))
    draw_text((view_xview[0] + 160), (view_yview[0] + 35), scr_gettext("labtv_tape3"))
    draw_text((view_xview[0] + 50), (view_yview[0] + 55), scr_gettext("labtv_tape4"))
    draw_text((view_xview[0] + 160), (view_yview[0] + 55), scr_gettext("labtv_tape5"))
