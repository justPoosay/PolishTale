...
if (draw_u > 0)
{
    ...
    if (draw_u >= 2)
    {
        ...
        draw_text_transformed(320, 140, scr_gettext("hardmode_end_1"), 3, 3, 20)
    }
    if (draw_u >= 3)
    {
        draw_set_color(c_yellow)
        scr_setfont(fnt_main)
        draw_text_transformed(320, 230, scr_gettext("hardmode_end_2"), 1.5, 1.5, 0)
    }
    if (draw_u >= 4)
    {
        yy = 270
        ...
        draw_set_color(c_yellow)
        scr_setfont(fnt_main)
        draw_text_transformed(320, yy, scr_gettext("hardmode_end_3"), 1, 1, 0)
    }
    if (draw_u >= 5)
    {
        yy = 305
        ...
        draw_set_color(c_yellow)
        scr_setfont(fnt_main)
        draw_text_transformed(320, yy, scr_gettext("hardmode_end_4"), 0.5, 0.5, 0)
    }
