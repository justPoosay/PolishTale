var roomname, lvtext, timetext, namesize, lvsize, timesize, x_center, lvpos, fileerased;
if (myinteract == 0)
...
if (drawthis == 1)
{
    ...
    name = ini_read_string("General", "Name", "PUSTE")
    ...
    draw_text((250 + xx - timesize), (60 + yy), timetext)
    if (global.language == "ja")
        scr_drawtext_centered(x_center, (80 + yy), roomname)
    else
        draw_text((70 + xx), (80 + yy), roomname)
    draw_text((xx + 85), (yy + 110), scr_gettext("save_menu_save"))
    draw_text((xx + 175), (yy + 110), scr_gettext("save_menu_return"))
}
if (con == 2)
{
...
if (con == 18)
{
    ...
    mywriter = instance_create((view_xview[0] + 30), (view_yview[0] + 100), obj_flowey_writer)
    con = 19
}
if (con == 19)
{
