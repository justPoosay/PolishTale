var soldout, i, pad, cost, str, namepos, namestr, xscale, hearty, heartx, textx, writerx;
if (menu == 1 || menu == 2)
{
    soldout = 0
    if (menuc[1] == 3)
...
if (menu == 1 || menu == 2)
{
    ...
    {
        str = scr_gettext("shop_buy_list", "500", "")
        draw_text(30, 190, str)
        namepos = 30 + string_width(str)
        namestr = scr_gettext("shop4_item_61_longname")
        xscale = (scr_shop_divider_pos() - 15 - namepos) / string_width(namestr)
        draw_text_transformed(namepos, 190, namestr, xscale, 1, 0)
    }
    else
    {
        draw_set_color(c_gray)
        draw_text(30, 190, scr_gettext("shop_buy_soldout"))
        draw_set_color(c_white)
    }
    ...
    if (menu == 2)
    {
        ...
        draw_text((heartx + 15), 170, scr_gettext("yes"))
        draw_text((heartx + 15), 185, scr_gettext("no"))
        hearty = 174
        if (global.language == "ja")
            hearty -= 2
