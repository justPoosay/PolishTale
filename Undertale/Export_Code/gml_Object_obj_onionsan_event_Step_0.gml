if instance_exists(obj_mainchara)
{
    ...
    if (global.flag[496] == 5 && obj_mainchara.x > 600 && obj_mainchara.x < 640 && global.interact == 0)
    {
    ...
    if (global.flag[496] == 6 && obj_mainchara.x > 600 && obj_mainchara.x < 640 && global.interact == 0 && once == 0)
    {
        if (onion.on != 4 && onion.on != 0)
        {
            once = 1
    ...
    if (global.flag[496] == 7 && obj_mainchara.x > 600 && obj_mainchara.x < 640 && global.interact == 0 && once == 0)
    {
        if (onion.on != 4 && onion.on != 0)
        {
            once = 1
