...
if (savetimer > 0)
{
    ...
    draw_set_alpha(sta)
    if (fileset == 2)
        draw_text_transformed(20, 430, scr_gettext("flowey_save", "2"), textscale, textscale, 0)
    if (fileset == 3)
        draw_text_transformed(20, 430, scr_gettext("flowey_save", "3"), textscale, textscale, 0)
    if (fileset == 6)
        draw_text_transformed(20, 430, scr_gettext("flowey_save", "6"), textscale, textscale, 0)
}
if (loadtimer > 0)
{
    sta = (10 + loadtimer) / 20
    ...
    {
        if (fileset == 3)
            draw_text_transformed((20 + flx), (430 + fly), scr_gettext("flowey_load", "3"), textscale, textscale, 0)
        if (fileset == 4)
            draw_text_transformed(20, 430, scr_gettext("flowey_load", "4"), textscale, textscale, 0)
        if (fileset == 5)
            draw_text_transformed(20, 430, scr_gettext("flowey_load_failed"), textscale, textscale, 0)
        if (fileset == 6)
            draw_text_transformed(20, 430, scr_gettext("flowey_load", "6"), textscale, textscale, 0)
    }
    else
        draw_text_transformed(20, 430, scr_gettext("flowey_load", "2"), textscale, textscale, 0)
}
if (darkmode == 1)
{
...
{
    draw_set_color(c_yellow)
    draw_text((room_width - 60), (room_height - 40), "debug")
}
