var l_char;
demonx = "..."
l_char = string_to_hiragana(string_lower(argument0))
...
else if (l_char == "toriel" || l_char == "とりえる")
{
    ...
    if (global.language == "ja")
        ...
        spec_m = "Myślę, że powinieneś#obmyśleć własne#imię, słońce."
}
...
else if (l_char == "undyne" || l_char == "あんだいん")
{
    ...
    if (global.language == "ja")
        ...
        spec_m = "Zdobądź swoje WŁASNE imię!"
}
else if (l_char == "flowey" || l_char == "ふらうぃ")
{
    ...
    if (global.language == "ja")
        ...
        spec_m = "Ja już WYBRAŁEM#to imię."
}
...
else if (l_char == "napsta" || l_char == "blooky" || l_char == "なぷすた" || l_char == "ぶるっち")
{
    ...
    if (global.language == "ja")
        ...
        spec_m = "...........#(Nie są w stanie#cię powstrzymać.)"
}
else if (l_char == "murder" || l_char == "mercy" || l_char == "ころす" || l_char == "みのがす")
{
    ...
    if (global.language == "ja")
        ...
        spec_m = "To jest trochę-#nakręcane, czyż nie...?"
}
...
else if (l_char == "catty" || l_char == "きゃってぃ")
{
    ...
    if (global.language == "ja")
        ...
        spec_m = "Bratty! Bratty!#To MOJE imię!"
}
...
else if (l_char == "mtt" || l_char == "metta" || l_char == "mett" || l_char == "めた" || l_char == "めたとん")
{
    ...
    if (global.language == "ja")
        ...
        spec_m = "OOOOH!!! CZY TY#PROMUJESZ MOJĄ POSTAĆ?"
}
...
else if (l_char == "bpants" || l_char == "ばがぱん")
{
    ...
    if (global.language == "ja")
        ...
        spec_m = "Naprawdę brakuje#ci pomysłów."
}
