...
if (argument0 == "music/badtom.ogg")
    song_index = mus_badtom
...
if (argument0 == "music/zz_megalovania_alt.ogg")
    song_index = mus_zz_megalovania_alt
...
if (argument0 == "music/zz_hysteria.ogg")
    song_index = mus_zz_hysteria
