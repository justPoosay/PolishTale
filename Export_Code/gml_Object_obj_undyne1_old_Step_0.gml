...
if (con == 17)
{
    ...
    global.typer = 5
    global.msc = 0
    global.msg[0] = "* Jo..^1. widziałeś^1, jak&  się na ciebie&  patrzyła...?/"
    global.msg[1] = "* To.../"
    global.msg[2] = "* ... było NIESAMOWITE!/"
    global.msg[3] = "* Jestem TAAAAAKI zazdrosny!/"
    global.msg[4] = "* Coś ty zrobił^1, że&  zyskałeś jej uwagę...^1?&* Ha ha./"
    global.msg[5] = "* No chodź^1!&* Chodźmy popatrzeć jak&  trzepie innym tyłki!/%%"
