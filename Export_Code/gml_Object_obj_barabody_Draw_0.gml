...
draw_sprite_ext(hand2pic, 0, (x + 140), (ręka + (cos(siner / 4)) * 4 + 16), 2, 2, ((sin(siner / 4)) * 4 - 30), c_white, 1)
...
draw_sprite_ext(hand1pic, 0, (x - 10), (ręka + (cos(siner / 4)) * 4 + 16), 2, 2, ((sin(siner / 4)) * 4), c_white, 1)
