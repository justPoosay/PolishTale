...
if (global.typer == 25)
{
    if (global.language == "ja")
        script_execute(SCR_TEXTSETUP, fnt_ja_plainsmall, c_white, (x + 20), (y + 20), (view_xview[view_current] + 290), 0, 1, SND_TXT1, 10, 15)
    else
        script_execute(SCR_TEXTSETUP, fnt_maintext, c_white, (x + 20), (y + 20), (view_xview[view_current] + 290), 0, 1, SND_TXT1, 8, 18)
}
if (global.typer == 27)
...
if (global.typer == 111)
    script_execute(SCR_TEXTSETUP, fnt_plain, c_black, x, y, (x + 190), 43, 1, SND_TXT1, 9, 20)
if (global.typer == 112)
    script_execute(SCR_TEXTSETUP, fnt_maintext, c_white, (x + 20), (y + 20), (view_xview[view_current] + 290), 0, 2, snd_nosound, 9, 18)
if (global.typer == 113)
...
if (global.typer == 115)
    script_execute(SCR_TEXTSETUP, fnt_main, c_white, (x + 20), (y + 20), (view_xview[view_current] + 999), 1.4, 4, snd_floweytalk2, 20, 36)
if (global.typer == 116)
    script_execute(SCR_TEXTSETUP, fnt_main, c_white, (x + 20), (y + 20), (view_xview[view_current] + 999), 2, 2, snd_floweytalk2, 20, 32)
if (global.typer == 117)
    script_execute(SCR_TEXTSETUP, fnt_main, c_white, (x + 20), (y + 20), (view_xview[view_current] + 999), 0, 1, snd_floweytalk2, 20, 32)
if (global.typer == 118)
    script_execute(SCR_TEXTSETUP, fnt_main, c_white, (x + 20), (y + 20), 9999, 0, 2, snd_nosound, 16, 32)
if (global.typer == 119)
    script_execute(SCR_TEXTSETUP, fnt_maintext, c_white, (x + 20), (y + 20), (view_xview[view_current] + 290), 0, 4, snd_floweytalk1, 8, 18)
if (global.typer == 120)
{
    if (global.language == "ja")
