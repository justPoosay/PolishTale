var namescale, infoscale, info_yofs, moldbygg_w_infoscale_x, tsunderplane_y_infoscale_x, pyrope_y_infoscale_x, pyrope_y_infoscale_y, ff_namescale_x;
namescale = 3
infoscale = 2
info_yofs = 0
...
if (active == true)
{
    ...
    if (global.cast_type == 3)
    {
        ...
        {
            draw_set_color(c_yellow)
            tsunderplane_y_infoscale_x = 1.5
        ...
        {
            pyrope_y_infoscale_x = 1.5
            pyrope_y_infoscale_y = 1.5
            draw_set_color(c_yellow)
