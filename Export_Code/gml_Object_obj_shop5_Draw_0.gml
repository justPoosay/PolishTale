var pad, hearty, heartx, textx, writerx, left_x, right_x, heart_space, max_width, price_width, separator, sep_width, xx, yy, value_x, name, scale, width, y_prompt, y_choice;
...
if (menu == 1 || menu == 2)
{
    ...
    if (global.language == "ja")
        pad = " "
    draw_text(30, 130, scr_gettext("shop_buy_list", (pad + "3"), scr_gettext("shop5_itemname_22a")))
    draw_text(30, 150, scr_gettext("shop_buy_list", (pad + "1"), scr_gettext("shop5_itemname_22b")))
    draw_text(30, 170, scr_gettext("shop_buy_list", "20", scr_gettext("shop5_itemname_22c")))
    if (murder == 0)
    {
        if (global.flag[276] != 1)
            draw_text(30, 190, scr_gettext("shop_buy_list", "1000", scr_gettext("shop5_itemname_college")))
        else
            draw_text(30, 190, scr_gettext("shop_buy_list", string(itemcost[3]), scr_gettext("shop5_itemname_64")))
    }
    else
        draw_text(30, 190, scr_gettext("shop_buy_list", "1000", scr_gettext("shop5_itemname_22d")))
    ...
    if (menu == 2)
    {
        ...
        draw_text((heartx + 15), 170, scr_gettext("shop5_buy_yes"))
        draw_text((heartx + 15), 185, scr_gettext("shop5_buy_no"))
        hearty = 174
        if (global.language == "ja")
            hearty -= 2
...
if (menu == 5)
{
    ...
    for (i = 0; i < 4; i += 1)
    {
        ...
        else if (sold[(i * 2)] == 1)
        {
            ...
            draw_text(xx, yy, scr_gettext("shop5_sell_sold"))
        }
    ...
    draw_text(200, 210, scr_gettext("shop5_sell_gold"))
    if control_check_pressed(0)
    {
        joytimer = 0
        buffer = 3
...
if (menu == 6)
{
    ...
    draw_text(80, y_choice, scr_gettext("shop5_sell_yes"))
    draw_text(190, y_choice, scr_gettext("shop5_sell_no"))
