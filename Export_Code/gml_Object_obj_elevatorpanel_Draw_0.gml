...
if (con == 2 && instance_exists(OBJ_WRITER) == 0)
{
    ...
    if (global.flag[398] != 0)
        draw_text((view_xview[0] + 50), (view_yview[0] + 15), scr_gettext("elevator_l1f"))
    else
        draw_text((view_xview[0] + 50), (view_yview[0] + 15), scr_gettext("elevator_cancel"))
    if (global.flag[398] != 1)
        draw_text((view_xview[0] + 160), (view_yview[0] + 15), scr_gettext("elevator_r1f"))
    else
        draw_text((view_xview[0] + 160), (view_yview[0] + 15), scr_gettext("elevator_cancel"))
    if (global.flag[398] != 2)
        draw_text((view_xview[0] + 160), (view_yview[0] + 35), scr_gettext("elevator_r2f"))
    else
        draw_text((view_xview[0] + 160), (view_yview[0] + 35), scr_gettext("elevator_cancel"))
    if (trigger > 0)
    {
        if (global.flag[398] != 3)
            draw_text((view_xview[0] + 50), (view_yview[0] + 35), scr_gettext("elevator_l2f"))
        else
            draw_text((view_xview[0] + 50), (view_yview[0] + 35), scr_gettext("elevator_cancel"))
    }
    if (trigger > 0)
    {
        if (global.flag[398] != 4)
            draw_text((view_xview[0] + 50), (view_yview[0] + 55), scr_gettext("elevator_l3f"))
        else
            draw_text((view_xview[0] + 50), (view_yview[0] + 55), scr_gettext("elevator_cancel"))
    }
    if (trigger > 1)
    {
        if (global.flag[398] != 5)
            draw_text((view_xview[0] + 160), (view_yview[0] + 55), scr_gettext("elevator_r3f"))
        else
            draw_text((view_xview[0] + 160), (view_yview[0] + 55), scr_gettext("elevator_cancel"))
    }
    heart_xpos = view_xview[0] + 30
    heart_ypos = view_yview[0] + 20
