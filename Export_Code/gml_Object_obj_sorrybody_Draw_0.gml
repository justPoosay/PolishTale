if (pause == 1)
{
    ...
    {
        draw_sprite_ext(spr_sorryarm_behind, 0, (x - 44), (y + 32), 2, 2, 0, c_white, 1)
        draw_sprite_ext(spr_sorryarm_drawing, global.flag[20], (x + 52), (y + 28), -2, 2, 0, c_white, 1)
    }
}
if (freeze == false && back == false && pause == 0)
{
    ...
    if (global.flag[20] == 0)
    {
        draw_sprite_ext(spr_sorryarm, global.flag[20], (x - 44 + (sin(siner / 3)) * 2), (y + 32), 2, 2, 0, c_white, 1)
        draw_sprite_ext(spr_sorryarm, global.flag[20], (x + 46 - (sin(siner / 3)) * 2), (y + 32), -2, 2, 0, c_white, 1)
    }
    ...
    if (global.flag[20] == 1)
    {
        draw_sprite_ext(spr_sorryarm_headgrab, global.flag[20], (x - 44 + (sin(siner / 3)) * 2), (y + 32), 2, 2, 0, c_white, 1)
        draw_sprite_ext(spr_sorryarm_headgrab, global.flag[20], (x + 46 - (sin(siner / 3)) * 2), (y + 32), -2, 2, 0, c_white, 1)
    }
    if (global.flag[20] == 2)
    {
        draw_sprite_ext(spr_sorryarm_behind, global.flag[20], (x - 44 + (sin(siner / 3)) * 2), (y + 32), 2, 2, 0, c_white, 1)
        draw_sprite_ext(spr_sorryarm_behind, global.flag[20], (x + 46 - (sin(siner / 3)) * 2), (y + 32), -2, 2, 0, c_white, 1)
    }
    if (global.flag[20] >= 3)
    {
        draw_sprite_ext(spr_sorryarm_behind, global.flag[20], (x - 44 + (sin(siner / 3)) * 2), (y + 32), 2, 2, 0, c_white, 1)
        draw_sprite_ext(spr_sorryarm_drawing, global.flag[20], (x + 52 - (sin(siner / 3)) * 2), (y + 28), -2, 2, 0, c_white, 1)
    }
}
if (back == true)
{
    ...
    if (tailtype == 1)
    {
        ...
        if (rot >= 58)
        {
            ...
            if (ch == 0)
                ch_color2 = merge_color(c_white, $FFA914, abs(sin(siner / 2)))
            if (ch == 1)
