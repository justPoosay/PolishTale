...
if (talk[0] == 1 && shake == 0)
{
    ...
    draw_text((guy.x + 220), (guy.y + text_yofs), scr_gettext("obj_bringitinguys_298"))
}
if (guy2.x > -24)
{
    guy2.x = -24
...
if (talk[1] == 1 && shake == 0)
{
    ...
    scr_setfont(fnt_plain)
    draw_set_color(c_black)
    draw_text((guy2.x + 120), (guy2.y + text_yofs), scr_gettext("obj_bringitinguys_314"))
}
if (guy3.x > -24)
{
    guy3.x = -24
...
if (talk[2] == 1 && shake == 0)
{
    ...
    scr_setfont(fnt_plain)
    draw_set_color(c_black)
    draw_text((guy3.x + 160), (guy3.y + text_yofs), scr_gettext("obj_bringitinguys_329"))
}
...
if (talk_r[0] == 1 && shake == 0)
{
    ...
    scr_setfont(fnt_plain)
    draw_set_color(c_black)
    draw_text((guy_r.x - 88), (guy_r.y + text_yofs), scr_gettext("obj_bringitinguys_355"))
}
...
if (talk_r[1] == 1 && shake == 0)
{
    ...
    scr_setfont(fnt_plain)
    draw_set_color(c_black)
    draw_text((guy_r2.x - 88), (guy_r2.y + text_yofs), scr_gettext("obj_bringitinguys_371"))
}
...
if (talk_r[2] == 1 && shake == 0)
{
    ...
    scr_setfont(fnt_plain)
    draw_set_color(c_black)
    draw_text((guy_r3.x - 88), (guy_r3.y + text_yofs), scr_gettext("obj_bringitinguys_387"))
}
