var wdiff, adiff, wdiffs, adiffs, soldout, divider_x, bratty_x, catty_x, i, pad, cost, hearty, heartx, textx, writerx;
if (menu == 1 || menu == 2)
{
...
if (menu == 1 || menu == 2)
{
    for (i = 0; i < 4; i++)
    {
        ...
        if soldout
        {
            ...
            draw_text(30, (130 + 20 * i), scr_gettext("shop_buy_soldout"))
            draw_set_color(c_white)
        }
        else
        {
