...
if (con == 34)
{
    ...
    con = 35
    global.flag[17] = 1
    doorb = instance_create(((view_xview[(0 << 0)]) - 20), (obj_mainchara.y + 10), obj_doorB)
    doora = instance_create(((view_xview[(0 << 0)]) + (view_wview[(0 << 0)]) + 20), (obj_mainchara.y + 10), obj_doorA)
    undynetimer = 0
    finaltimer = 0
    mkidtalk = 0
    charge = 0
